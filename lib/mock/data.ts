...
export const categories: Category[] = [
  ...
  { id: '4', name: 'अंतरराष्ट्रीय', nameEn: 'International', slug: 'international', icon: '🌍', color: '#8B5CF6' },
...
export const epaperEditions: EpaperEdition[] = [
  {
    ...
    pages: [
      ...
      { id: 'p3', name: 'अंतरराष्ट्रीय', nameEn: 'International', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&h=800&fit=crop' },
